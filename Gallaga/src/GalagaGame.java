...
/*	private void board(){
	...
	public void fire() {
		...
		ShotSprite shot1 = new ShotSprite(this, shotImage, starship.getX() + 10, starship.getY() - 30); // 총알 복붙
		/*ShotSprite shot2 = new ShotSprite(this, shotImage, starship.getX() + 7, starship.getY() - 50); // 총알 복붙
*/		
		sprites.add(shot);
		sprites.add(shot1);
		/*sprites.add(shot2);*/
